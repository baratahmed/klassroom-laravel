<header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        @auth
        <a class="btn btn-sm btn-outline-secondary mr-2" href="{{route('dashboard')}}">Profile ({{optional(Auth::user())->full_name}})</a>

        <a class="btn btn-sm btn-outline-secondary" href="{{route('last-login-setdate')}}">last login</a>
